...
you should place you code here."
  ...
  (setq eclim-eclipse-dirs "~/eclipse-jee-neon-R-linux-gtk-x86_64/eclipse"
        eclim-executable "~/eclipse-jee-neon-R-linux-gtk-x86_64/eclipse/eclim")
  (setq
   ;; Use another eclimd executable
   ;; eclimd-executable "/path/to/another/executable"
   ;; Specify the workspace to use by default
   eclimd-default-workspace "~/eclipse-ws/tennet"
